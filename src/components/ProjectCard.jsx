  ...
  const projects = [
    {
      ...
      description:'Is a dedicated webpage designed to promote an upcoming or released film. It provides essential details about the movie, engages visitors with visually appealing content, and encourages them to watch the film or stream it online.',
      language: {
         language1:'Html',
         language2:'Css',
      }
    ...
    },
    {
      ...
      demoLink:'ethio-gym.netlify.app',
      description:'A job board website is an online platform that connects job seekers with employers by listing job openings across various industries. It serves as a digital marketplace where employers can post job opportunities, and job seekers can browse, apply, and track job applications.',
      language: {
         language1:'React',
         language2:'Tailwind',
         language3:'Express',
    ...
    },
    {
      ...
      demoLink:'ethio-gym.netlify.app',
      description:'An agricultural support website is an online platform designed to assist farmers, agribusinesses, and agricultural professionals by providing resources, tools, and information to improve productivity, sustainability, and profitability.',
      language: {
         language1:'Html',
         language2:'Bootstrap',
         language3:'Php',
    ...
    {projects.map((project) => (
      ...
      >
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <p className=" text-gray-600 text-lg mb-4 flex-grow">{project.description}</p>
